...
//   GlobalKey _cardKey = GlobalKey(); // GlobalKey to capture BigContainer
...
//   // Capture the widget image using the GlobalKey
//   final imageBytes = await captureWidgetToImage(_cardKey);
//   if (imageBytes != null) {
//     print("Captured image with ${imageBytes.length} bytes");
...
//     // Get the RenderObject for the widget using its GlobalKey
//     RenderRepaintBoundary boundary =
//         context.findRenderObject() as RenderRepaintBoundary;

//     // Convert the boundary into a ui.Image
//     ui.Image image = await boundary.toImage(pixelRatio: 3.0);

//     // Convert the ui.Image into a byte data object
//     ByteData? byteData =
//         await image.toByteData(format: ui.ImageByteFormat.png);

//     // If the byteData is not null, return the byte data as a Uint8List
//     if (byteData != null) {
...
//     ref.watch(getVendorCardProvider(9)).whenData(
//       (value) {
//         print("kalu ${value}");
//         _card = BigContainer(
//             key: _cardKey,
