...
part 'thread_is_important_api.g.dart';

@riverpod
Future<String> makethreadimportant(ref, {required String id}) async {
  final SmartClient client = SmartClient();
  try {
    final response = await client.request(
      requestType: RequestType.postWithToken,
      url: 'https://smartbazaar.jianjun-rnd.com.np/api/threads/thread_is_important/$id',
