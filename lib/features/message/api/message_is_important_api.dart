...
final isMessageImportantProvider = StateProvider.family<bool, String>((ref, threadId) => false);

/// API function for marking the message as important
@riverpod
Future<bool> markMessageIsImportant(MarkMessageIsImportantRef ref, String threadId) async {
  ...
  try {
    ...
    if (response.statusCode == 200 && response.data['data'] == "success") {
      ...
      ref.read(isMessageImportantProvider(threadId).notifier).state = true; // Mark as important
      return true;
    } else {
