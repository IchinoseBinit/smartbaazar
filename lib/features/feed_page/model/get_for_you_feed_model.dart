...
class GetForYouFeedModel with _$GetForYouFeedModel {
  ...
  factory GetForYouFeedModel.fromJson(Map<String, dynamic> json) => _$GetForYouFeedModelFromJson(json);
}
...
class StoryPost with _$StoryPost {
  ...
  factory StoryPost.fromJson(Map<String, dynamic> json) => _$StoryPostFromJson(json);
}
