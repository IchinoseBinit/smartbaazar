                    ...
                    child: Column(
                      children: [
                        ...
                        asyncbajarValue.when(
                          data: (data) {
                            if (data.sliders == null || data.sliders!.isEmpty) {
                              // If sliders is null or empty, return an empty widget or simply return SizedBox.shrink
                              return SizedBox
                                  .shrink(); // This ensures no space is occupied
                            }
