...
class _$ContactUsModelImpl implements _ContactUsModel {
  ...
  @override
  String toString() {
    return 'ContactUsModel(firstName: $firstName, lastName: $lastName, email: $email, message: $message, countryCode: $countryCode, countryName: $countryName, companyName: $companyName)';
  }
