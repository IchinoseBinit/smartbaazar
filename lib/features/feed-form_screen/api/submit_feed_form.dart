...
@riverpod
Future<bool> postFeedForm(ref, String captionTitle, String caption,
    String offers, List<String> products, File imageFile) async {
  final SmartClient client = SmartClient();
  print('bibash ${products}');
  try {
    FormData formData = FormData.fromMap({
      ...
      'offers': offers,
      'products': products
          .join(','), // Convert List<String> to a comma-separated string
    });
