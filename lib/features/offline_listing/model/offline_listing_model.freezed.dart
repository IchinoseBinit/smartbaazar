...
OfflineListingModel _$OfflineListingModelFromJson(Map<String, dynamic> json) {
  return _OfflineListingModel.fromJson(json);
}

/// @nodoc
mixin _$OfflineListingModel {
  Products? get products => throw _privateConstructorUsedError;

  /// Serializes this OfflineListingModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of OfflineListingModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $OfflineListingModelCopyWith<OfflineListingModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OfflineListingModelCopyWith<$Res> {
  factory $OfflineListingModelCopyWith(
          OfflineListingModel value, $Res Function(OfflineListingModel) then) =
      _$OfflineListingModelCopyWithImpl<$Res, OfflineListingModel>;
  @useResult
...
/// @nodoc
class _$OfflineListingModelCopyWithImpl<$Res, $Val extends OfflineListingModel>
    implements $OfflineListingModelCopyWith<$Res> {
  _$OfflineListingModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OfflineListingModelImplCopyWith<$Res>
    implements $OfflineListingModelCopyWith<$Res> {
  factory _$$OfflineListingModelImplCopyWith(_$OfflineListingModelImpl value,
          $Res Function(_$OfflineListingModelImpl) then) =
      __$$OfflineListingModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({Products? products});
...
/// @nodoc
class __$$OfflineListingModelImplCopyWithImpl<$Res>
    extends _$OfflineListingModelCopyWithImpl<$Res, _$OfflineListingModelImpl>
    implements _$$OfflineListingModelImplCopyWith<$Res> {
  __$$OfflineListingModelImplCopyWithImpl(_$OfflineListingModelImpl _value,
      $Res Function(_$OfflineListingModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OfflineListingModelImpl(
      products: freezed == products
          ? _value.products
          : products // ignore: cast_nullable_to_non_nullable
              as Products?,
...
/// @nodoc
@JsonSerializable()
class _$OfflineListingModelImpl implements _OfflineListingModel {
  const _$OfflineListingModelImpl({required this.products});

  factory _$OfflineListingModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$OfflineListingModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OfflineListingModel(products: $products)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OfflineListingModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OfflineListingModelImplCopyWith<_$OfflineListingModelImpl> get copyWith =>
      __$$OfflineListingModelImplCopyWithImpl<_$OfflineListingModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OfflineListingModelImplToJson(
      this,
    );
  }
}

abstract class _OfflineListingModel implements OfflineListingModel {
  const factory _OfflineListingModel({required final Products? products}) =
      _$OfflineListingModelImpl;

  factory _OfflineListingModel.fromJson(Map<String, dynamic> json) =
      _$OfflineListingModelImpl.fromJson;
