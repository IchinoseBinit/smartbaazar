...
part 'offline_listing_model.freezed.dart';
part 'offline_listing_model.g.dart';

@freezed
class OfflineListingModel with _$OfflineListingModel {
  const factory OfflineListingModel({
    required Products? products,
  }) = _OfflineListingModel;

  factory OfflineListingModel.fromJson(Map<String, dynamic> json) =>
      _$OfflineListingModelFromJson(json);
}
