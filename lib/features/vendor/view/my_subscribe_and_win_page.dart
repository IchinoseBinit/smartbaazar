...
class _MySubscribeAndWinPageState extends ConsumerState<MySubscribeAndWinPage>
  ...
  late TabController subscriptiondynamiccontroller;
  bool _showSearchProductModels = false;
  ...
  @override
  void initState() {
    subscriptiondynamiccontroller = TabController(length: 3, vsync: this);
    ...
    _timer = Timer.periodic(const Duration(seconds: 5), (Timer timer) {
      ...
      subscriptiondynamiccontroller.addListener(() {
        setState(() {});
      });
  ...
  void dispose() {
    ...
    subscriptiondynamiccontroller.dispose();
  }
